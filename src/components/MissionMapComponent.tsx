...
/**
 * CodeFly Academy – Mission Map Pack (Production-Ready)
 * ==================================================
 * Hand-off bundle for a senior engineer to drop into any React app.
 * Includes:
 *   • SVG mission map @ 1200×800 with 8 Agent Academy missions (tactical path)
...
export const DEFAULT_MISSIONS: Mission[] = [
  { id: 1, key: "binary-shores",     name: "Binary Shores Academy",    x: 120,  y: 380, status: "completed", icon: "castle",   route: "/mission/binary-shores-academy" },
  { id: 2, key: "variable-village",  name: "Variable Village",          x: 380,  y: 200, status: "completed", icon: "warehouse", route: "/mission/variable-village" },
  { id: 3, key: "logic-lake",        name: "Logic Lake Outpost",        x: 600,  y: 180, status: "current",   icon: "tower",    progress: 0.5, route: "/mission/logic-lake-outpost" },
  { id: 4, key: "loop-canyon",       name: "Loop Canyon Base",          x: 950,  y: 180, status: "locked",    icon: "factory",  route: "/mission/loop-canyon-base" },
  { id: 5, key: "function-forest",   name: "Function Forest Station",   x: 1080, y: 320, status: "locked",    icon: "lab",      route: "/mission/function-forest-station" },
  { id: 6, key: "array-mountains",   name: "Array Mountains Facility",  x: 950,  y: 620, status: "locked",    icon: "array",    route: "/mission/array-mountains-facility" },
  { id: 7, key: "object-oasis",      name: "Object Oasis Complex",      x: 620,  y: 660, status: "locked",    icon: "studio",   route: "/mission/object-oasis-complex" },
...
export const useQuest = () => {
  ...
  if (!ctx) throw new Error("useMission must be used inside <MissionMapProvider>");
  return ctx;
};

export function MissionMapProvider({
  adapter,
  userId,
  courseId,
  initialRecord,
...
export function CodeFlyMissionMap({
  backgroundImageUrl,
  onNodeClick,
  missionsOverride,
  structures = [],
...
/**
 * MissionMapDemo – drop-in page that demonstrates full stack:
 *   - Provider with Supabase or REST adapter
 *   - Export-to-PNG
 *   - Advance/reset, set progress, route mapping
 */
export default function MissionMapDemo({
  adapter,
  userId = "demo-user-1",
  ...
  return (
    <MissionMapProvider adapter={adapter} userId={userId} courseId={courseId} initialRecord={initial}>
            ...
            <div className="xl:col-span-3">
              <div className="bg-slate-900 rounded-xl border border-red-700/30 shadow-2xl overflow-hidden">
                ...
                <div className="relative">
                  <CodeFlyMissionMap backgroundImageUrl={backgroundImageUrl} onNodeClick={onNodeClick} />
                  {/* Tactical Overlay */}
