    ...
    modes: [
      {
        ...
        learn_md: `## 🎯 Welcome to Binary Shores Academy - Your First Mission Begins

**CLASSIFIED TRANSMISSION - CLEARANCE LEVEL: RECRUIT**

Congratulations, Agent. You've been selected for the elite **Binary Shores Academy** program. Your mission: master the fundamental building blocks of digital intelligence - **variables and data types** - the very foundation that elite coders use to build secure systems and analyze critical data.
