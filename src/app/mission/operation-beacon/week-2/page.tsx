  ...
  const lessons = [
    {
      ...
      route: '/mission/operation-beacon/week-2/lesson-1'
    },
    {
      id: 2,
      ...
      route: '/mission/operation-beacon/week-2/lesson-2'
    },
    {
      id: 3,
      ...
      route: '/mission/operation-beacon/week-2/lesson-3'
    },
    {
      id: 4,
      ...
      route: '/mission/operation-beacon/week-2/lesson-4'
    }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${showAnimation ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Operation Beacon - Phase 2</h2>
