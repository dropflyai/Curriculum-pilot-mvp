...
export default function Lesson4() {
  ...
  const outroDialogue = [
    ...
    {
      character: "Commander Atlas",
      text: "Outstanding progress, Agent! Week 1 of Binary Shores Academy is complete. Your AI now has variables, data types, conditionals, and functions - the core of intelligence.",
      image: "/Commander Atlas.png",
      emotion: "confident" as const,
      effect: "pulse" as const
    },
